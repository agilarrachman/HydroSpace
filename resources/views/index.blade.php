                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex justify-content-between xs-hide">
                                <div class="d-flex">
                                    <div class="topbar-widget me-3"><a href="#"><i class="icofont-clock-time"></i>Senin - Jum'at 08.00 - 18.00</a></div>
                                    <div class="topbar-widget me-3"><a href="#"><i class="icofont-location-pin"></i>Jl. Raya Pajajaran, Kota Bogor, Jawa Barat 16128</a></div>
                                    <div class="topbar-widget me-3"><a href="#"><i class="icofont-envelope"></i>penyungoding@gmail.com</a></div>
                                </div>
            ...
            <div class="container relative z-2">
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 col-sm-6 order-lg-2 order-sm-1">
                        <div class="widget">
                            <div class="fw-bold text-white"><i class="icofont-clock-time me-2 id-color-2"></i>Waktu Operasional</div>
                            Senin - Jum'at 08.00 - 18.00

                            <div class="spacer-20"></div>

                            <div class="fw-bold text-white"><i class="icofont-location-pin me-2 id-color-2"></i>Lokasi Kantor</div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="de-flex">
                                <div class="de-flex-col">
                                    Copyright 2025 - HydroSpace by Penyu Ngoding
                                </div>
