                                        ...
                                        <div class="d-flex align-items-center row">
                                            <div class="col-sm-4 text-center">
                                                ...
                                                <div class="d-flex pb-4 gap-2 justify-content-center">
                                                    ...
                                                    <a href="/dashboard/profile/update" class="btn btn-primary"><i class="bx bx-edit me-2"></i>Edit Akun</a>
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="card-body">
                                                    <form>
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control disabled" id="username" name="username" value="johndoe" readonly>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="phone" class="form-control" id="phone" name="phone" value="081512341234" readonly>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
