            ...
            <div class="layout-page">
                ...
                <nav
                    ...
                    <div class="navbar-nav-right d-flex align-items-center justify-content-between" id="navbar-collapse">
                        <h5 class="mb-0">Edit Data Video</h5>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="authentication-wrapper authentication-basic container-p-y">
                            <div class="authentication-inner" style="max-width: 100%;">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form id="formAuthentication" class="mb-3" action="/dashboard/videos/{{ $video->slug }}" method="POST" enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
                                            <input type="hidden" name="admin_id" value="{{ $video->admin_id }}">

                                            <div class="row mb-3">
                                                <div class="col-lg-6 mb-3 mb-lg-0">
                                                    <label for="video" class="form-label">Video</label>
                                                    <div id="videoPreviewContainer" class="me-2 video-container" style="aspect-ratio: 16/9; width: 100%;">
                                                        <video class="video-preview rounded-2 form-control" id="videoPreview" controls style="width: 100%; height: 100%; object-fit: cover;">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="me-2 img-container" style="aspect-ratio: 16/9; width: 100%;">
                                                        <img class="img-preview rounded-2 form-control" src="{{ asset('storage/' . $video->thumbnail) }}" style="width: 100%; height: 100%; object-fit: cover;">
                                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="category_id" name="category_id">
                                                    ...
                                                    <option value="{{ $videoCategory->id }}" {{ $video->category_id == $videoCategory->id ? 'selected' : '' }}>
                                                        {{ $videoCategory->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="difficulty_level" name="difficulty_level">
                                                    <option value="Pemula" {{ old('difficulty_level', $video->difficulty_level) == 'Pemula' ? 'selected' : '' }}>Pemula</option>
                                                    <option value="Menengah" {{ old('difficulty_level', $video->difficulty_level) == 'Menengah' ? 'selected' : '' }}>Menengah</option>
                                                    <option value="Ahli" {{ old('difficulty_level', $video->difficulty_level) == 'Ahli' ? 'selected' : '' }}>Ahli</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('products') is-invalid @enderror" id="products" name="products" placeholder="Masukkan produk terkait" value="{{ old('products', $video->products) }}" />
                                            ...
                                            <button class="btn btn-primary d-grid w-100" type="submit" onclick="return confirm('Apakah kamu yakin akan mengubah data video ini?')">Simpan Perubahan</button>
                                        </form>
                                    </div>
                                </div>
                                <!-- /Create Product -->
                    ...
                    <script>
                        ...
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            const tagify = new Tagify(input, {
                                ...
                                whitelist: [], // Akan diisi nanti dari server
                                dropdown: {
                                    maxItems: 10,
                                    classname: "tags-look",
                                    enabled: 0,
                            ...
                            // Fetch data produk dari server (semua produk)
                            fetch('/dashboard/getProducts')
                                ...
                                .catch(error => console.error('Gagal mengambil daftar produk:', error));

                            // Fetch produk yang sudah dipilih (old value)
                            const videoId = "{{ $video->slug }}"; // Pakai slug karena getRouteKeyName()
                            fetch(`/dashboard/getSelectedProducts/${videoId}`)
                                .then(response => {
                                    if (!response.ok) {
                                        throw new Error('Gagal mengambil produk yang sudah dipilih');
                                    }
                                    return response.json();
                                })
                                .then(selectedProducts => {
                                    tagify.addTags(selectedProducts);
                                })
                                .catch(error => console.error(error));

                            // Ubah input agar data dikirim dalam format JSON
                            input.addEventListener("change", function() {
                                this.value = JSON.stringify(tagify.value.map(tag => tag.id));
                            });
                        });
                    </script>
</body>
