                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex justify-content-between mb-4">
                            <a href="/dashboard/videos/create" class="btn btn-primary">
                                <i class="bx bx-plus-circle me-2"></i> Tambah Video
                            </a>
                            <form action="/dashboard/videos" class="d-flex" style="max-height: 39px;">
                                <div class="input-group">
                                    <input type="text" name="search" class="form-control outline-secondary" placeholder="Cari Video" value="{{ request('search') }}">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('../storage/' . $video->thumbnail) }}" style="aspect-ratio: 16 / 9; width: 100px; object-fit: cover;" />
                                            </td>
                                            <td>{{ $video->title }}</td>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="/dashboard/videos/{{ $video->slug }}"><i class="bx bx-show me-1"></i> Lihat</a>
                                                        <a class="dropdown-item" href="/dashboard/videos/{{ $video->slug }}/edit"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">
                                                            <form action="/dashboard/videos/{{ $video->slug }}" method="post">
                                                                @method('delete')
                                                                @csrf
                                                                <button class="btn p-0 w-100" onclick="return confirm('Apakah kamu yakin akan menghapus data video ini?')">
