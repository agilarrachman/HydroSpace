                                        ...
                                        <div class="d-flex align-items-center row">
                                            <div class="col-sm-4 text-center">
                                                <div class="card-body px-0 px-md-4">
                                                    <img src="{{ asset('assets/img/avatars/1.png') }}" height="175" class="rounded-circle"/>
                                                </div>
                                                <div class="px-4 mb-4">
                                                    ...
                                                    <form>
                                                        <div class="row align-items-center">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control disabled" id="username" name="username" value="johndoe">
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label for="nama_lengkap" class="form-label">Nama Lengkap</label>
                                                                <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="John Doe">
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="phone" class="form-control" id="phone" name="phone" value="081512341234">
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="date" class="form-control" id="date_joined" name="date_joined" value="2023-01-01" readonly>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <a href="/dashboard/profile" class="btn btn-outline-primary w-100">Batal</a>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
